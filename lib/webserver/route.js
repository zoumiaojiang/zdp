        ...
        resp.on('end', function () {
            ...
            if (content !== 'null' && lor === 'left') {
                data = data.replace('<div id="content_left">',
                    ...
                    +         ' data-op="{&quot;y&quot;:&quot;FF9DF67E&quot;}" '
                    +         ' data-click="{&quot;p1&quot;:&quot;1&quot;,&quot;rsv_bdr&quot;:&quot;0&quot;,&quot;p5&quot;:1}"'
 ...
 */
function linkPHPToNode(res, mod) {
    ...
    function status(statuscode) {
        ...
        redirect(res, bodyBuffer.join(''));
    }

    var child = require('child_process').spawn (
        'php', [
            path.resolve(__dirname, '../../env/index.php'), 
            path.resolve(__dirname, '../../../page/' +  mod),
...
function transmitByKey(req, res) {
    ...
    module ? linkPHPToNode(res, module) : redirect(res, 'null');
}
